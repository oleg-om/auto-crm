...
import DiskpaintingsRowBoss from '../../components/diskpaintings/diskpaintings.row.boss'
...
const DiskpaintingsListBoss = () => {
  ...
  const paginate = (pageNumber) => {
    navigateWithQueryParams(`/diskpaintingboss/list/${pageNumber}`)
  }
  ...
  return (
    <div>
      ...
      <div>
        ...
        <Link to={`/diskpaintingboss/create/${num ? Number(num) : ''}`}>
          <button
            type="button"
...
export default DiskpaintingsListBoss
