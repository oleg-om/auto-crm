...
export default class VozvratToPrint extends React.PureComponent {
  render() {
    return (
      <div className="m-5 p-5 print-container">
        <div className="w-full text-center">
          <p>
            <strong>АКТ ВОЗВРАТА</strong>
          </p>
          <p>
            <strong>имущества с ответственного хранения № {this.props.props.id_storages}</strong>
          </p>
          <p>
            <strong>
              от{' '}
        ...
        <p>
          ...
          возврата товара с ответственного хранения, переданного Хранителю в рамках Договора
          сезонного хранения автомобильных шин
        </p>
        <p>&nbsp;</p>
        <ol>
          <li>
            Хранитель сдал, а Владелец принял после ответственного хранения Имущество в следующем
            составе:
          </li>
        </ol>
        ...
        <ol start="2">
          <li>
            Товар, возвращаемый Хранителем Владельцу, передается в полном количестве и надлежащего
            качества. Претензий Владелец к Хранителю не имеет.
          </li>
        </ol>
        <p>
          <strong>
