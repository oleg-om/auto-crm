...
const StorageViewOrder = (props) => {
  ...
  const changeStorage = () => {
    ...
    history.push(`/storages/order/list/${props.num ? props.num : ''}`)
  ...
  return (
    <div className="p-5">
          ...
          <div className="md:m-3 lg:flex rounded-lg px-6 py-2 w-auto shadow bg-gray-100 my-2">
            ...
            <div className="text-center md:text-left m-3">
              ...
              <div>
                ...
                {/* <Link
                  to={`/storages/editfull/${props.id_storages}`}
                  className="py-2 px-3 bg-main-600 text-white text-sm hover:bg-main-700 hover:text-white rounded-full h-22 w-22"
                >
                  Заказы клиента
                </Link> */}
              ...
              <div className="-mx-3 md:flex mb-2">
                <div className="overflow-x-auto md:w-auto px-3 mb-6 md:mb-0">
                  {props.preorder.map((it) => (
                    <p key={it.storageItem}>
                      {it.storageItem} {it.quantity ? `- ${it.quantity} шт` : null}
                    </p>
                  ))}
                </div>
              </div>
      ...
      <SubmitButtons sendData={changeStorage} />
    </div>
  )
}

export default StorageViewOrder
