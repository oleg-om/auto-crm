...
import { importWashprice, deleteWashpriceDb, getWashprices } from '../../redux/reducers/wash.prices'
...
interface IWashpriceImportProps {
  onSaved: () => void
  onCancel: () => void
}

const WashpriceImport = ({ onSaved, onCancel }: IWashpriceImportProps) => {
  ...
  const sendData = () => {
    ...
    dispatch(importWashprice(loadingData))
    ...
    <div className="flex flex-1 flex-col overflow-hidden">
      <div className="flex flex-1 flex-col overflow-y-auto px-6 py-4">
        <FieldGroup>
          ...
          <Field>
            <FieldLabel htmlFor="washprice-file">Загрузите файл Xls или Xlsx</FieldLabel>
            <Input
              id="washprice-file"
              type="file"
              accept=".xls,.xlsx"
...
export default WashpriceImport
