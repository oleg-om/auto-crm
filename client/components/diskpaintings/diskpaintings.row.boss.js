...
const DiskpaintingsRowBoss = (props) => {
  ...
  const applyDiscountWithFreeService = (number) => Number(number) - Number(number)
    ...
    >
      ...
      <td className="w-auto p-2 text-gray-800 text-sm text-center border border-b table-cell static">
        <div className="flex flex-row justify-center">
          <Link
            to={{
              pathname: `/diskpaintingboss/edit/${props.id_diskpaintings}/${props.num ? props.num : ''}`,
...
export default DiskpaintingsRowBoss
