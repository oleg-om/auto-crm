...
const EmployeeUpdate = (props) => {
  ...
  const [state, setState] = useState({
    ...
    positionIdAdditional: props.positionIdAdditional || ''
  })
      ...
      <div className="bg-white shadow rounded-lg px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
        ...
        <div className="-mx-3 md:flex flex-wrap mt-3">
          ...
          <div className="md:w-1/3 px-3 mb-6 md:mb-0 flex flex-col">
            <label
              className="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2"
              htmlFor="positionIdAdditional"
            >
              Дополнительная должность (для электронного журнала)
            </label>
            <div className="flex-shrink w-full inline-block relative mb-3">
              <select
                className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-gray-300 focus:border-gray-500 focus:outline-none rounded py-3 px-4 mb-3"
                value={state.positionIdAdditional}
                name="positionIdAdditional"
