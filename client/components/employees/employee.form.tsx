      ...
      <div className="flex flex-1 flex-col gap-4 overflow-y-auto px-6 py-4">
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                className={cn(
                  errors.surname && 'border-destructive focus-visible:ring-destructive'
                )}
                onChange={onChange}
              />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Сотрудник может занимать сразу несколько должностей</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Должность для электронного журнала</CardTitle>
          </CardHeader>
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <div className="grid gap-2">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Точки работы</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
              {places.map((it) => (
        ...
        <Card>
          <CardHeader>
            <CardTitle>Шиномонтаж</CardTitle>
          </CardHeader>
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <div className="grid gap-2">
