...
const DiskpaintingpriceRow = (props) => {
  const remove = (e) => {
    props.deleteDiskpaintingprice(props.id, e.target.value)
  }

  return (
    <tr className="bg-white lg:hover:bg-gray-100 text-xs flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-nowrap mb-5 lg:mb-0">
      ...
      <td className="w-full lg:w-auto p-2 text-gray-800 text-center border border-b block lg:table-cell relative lg:static whitespace-nowrap">
        <Link
          to={`/diskpaintingprice/legk/edit/${props.id}`}
