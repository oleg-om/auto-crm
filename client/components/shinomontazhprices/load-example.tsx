...
const COLUMNS = ['name', 'type', 'category', 'number', 'free', 'time', 'R13', 'R14', 'R15']

const EXAMPLE_ROWS: string[][] = [
  ['Осмотр покрышки', 'legk', 'sedan', '1', 'no', '5', '20', '25', '30'],
  ['Комплекс монтаж 4 колёс', 'legk', 'crossover', '2', 'yes', '', '1200', '1300', '1400'],
  ['Чистка диска (мойка колеса)', 'legk', 'runflat', '3', 'no', '10', '50', '60', '70']
]
