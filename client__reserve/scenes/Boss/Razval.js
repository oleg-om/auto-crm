...
const Razval = ({ reportRazval, placeList, razvalStatuses }) => {
  return (
    <div className="mb-3">
      <h2 className="text-xl font-semibold mb-2">Развал</h2>
            ...
            .map((it) => (
              ...
              >
                ...
                <td className="w-full lg:w-auto p-2 text-gray-800 text-left lg:text-center border border-b block lg:table-cell relative lg:static">
                  ...
                  {reportRazval.filter((item) => item.place === it.id).length}
                </td>
                <td className="w-full lg:w-auto p-2 text-gray-800 text-left lg:text-center border border-b block lg:table-cell relative lg:static">
